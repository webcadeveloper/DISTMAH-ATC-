          ...
          <div className="lg:col-span-3 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
              <div className="p-8">
                ...
                <h1 className="text-4xl font-bold text-neutral-900 mb-4">{lesson.title}</h1>

                {lesson.excerpt && (
                  <p className="text-lg text-neutral-600 mb-6 leading-relaxed">{lesson.excerpt}</p>
                )}

                {lesson.duration && (
                  <div className="flex items-center gap-2 text-neutral-600 mb-8 pb-8 border-b border-neutral-200">
              ...
              {lesson.content && (
                <div className="px-8 pb-8">
                  ...
                  <div className="prose prose-lg max-w-none prose-headings:text-neutral-900 prose-p:text-neutral-700 prose-a:text-blue-600 prose-strong:text-neutral-900 prose-code:text-blue-600 prose-code:bg-blue-50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:bg-neutral-900 prose-pre:text-neutral-100">
              ...
              <div className="px-8 pb-8">
                <div className="bg-neutral-50 rounded-lg p-6 border border-neutral-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-neutral-900 mb-2">Archivos de Ejercicio</h3>
