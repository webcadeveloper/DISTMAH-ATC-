        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Prerequisitos</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 sticky top-4">
              <div className="text-center mb-6">
                <div className="text-4xl font-bold text-gray-900 mb-2">
                  ${course.precio}
                  <span className="text-xl text-gray-600 ml-2">{course.moneda}</span>
                </div>
                <p className="text-gray-600">{course.duracion}</p>
              </div>
              ...
              {course.certificacion && (
                <div className="border-t border-gray-200 pt-6 mt-6">
                  ...
                  <p className="text-sm text-gray-600">{course.certificacion.nombre}</p>
                </div>
              )}
            </div>
          </div>
