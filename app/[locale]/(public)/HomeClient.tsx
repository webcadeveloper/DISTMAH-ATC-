...
export default function HomeClient({ courses, totalCourses, totalStudents }: HomeClientProps) {
    useEffect(() => {
        document.title = 'DISTMAH ATC - Universidad Autodesk | Cursos de AutoCAD, Revit, Civil 3D';
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute('content', 'Centro de Entrenamiento Autorizado (ATC) de Autodesk en Venezuela. Cursos certificados de AutoCAD, Revit, Civil 3D, Navisworks.');
        }
    }, []);
                ...
                <div className="border-t border-white/10 bg-black/20 backdrop-blur-sm relative z-10">
                    <div className="container mx-auto px-4 py-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                            {[
                                { label: "Cursos Especializados", value: totalCourses, suffix: "" },
                                { label: "Estudiantes Certificados", value: totalStudents, suffix: "+" },
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div>
                            ...
                            <p className="text-lg text-neutral-300 max-w-2xl">
                                Inicia tu camino profesional con nuestros cursos más demandados.
                            </p>
                        </div>
                        <Link href="/cursos">
                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    <ScrollReveal direction="up" className="max-w-2xl mx-auto">
                        ...
                        <p className="text-xl text-neutral-300 mb-10">
                            Únete a más de {totalStudents} profesionales que han impulsado su carrera con nosotros.
                        </p>
                        <Link href="/cursos">
