  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900">Foro de la Comunidad</h1>
          <p className="text-neutral-600">Comparte conocimiento y resuelve dudas con otros estudiantes</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div>
            <h2 className="text-xl font-bold text-neutral-900 mb-4">Categorías</h2>
            <div className="space-y-4">
              {mockCategorias.map((categoria) => (
                <Card key={categoria.id} className="border border-neutral-200 hover:shadow-md transition-shadow cursor-pointer">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-grow">
                        <h3 className="font-bold text-neutral-900 mb-1">{categoria.nombre}</h3>
                        <p className="text-sm text-neutral-600 mb-3">{categoria.descripcion}</p>
          ...
          <div>
            <h2 className="text-xl font-bold text-neutral-900 mb-4">Temas Recientes</h2>
            <div className="space-y-3">
              {mockTemasRecientes.map((tema) => (
                <Card key={tema.id} className="border border-neutral-200 hover:shadow-md transition-shadow cursor-pointer">
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-grow">
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="font-semibold text-neutral-900">{tema.titulo}</h3>
                          {tema.esPopular && (
                        ...
                        <div className="flex items-center gap-3 text-xs text-neutral-600">
                          ...
                          <span>•</span>
                          <span className="text-blue-600">{tema.categoria}</span>
                          <span>•</span>
            ...
            <Button variant="outline" className="w-full mt-4 border-neutral-200">
              Ver Más Temas
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <Card className="border border-neutral-200">
            <CardContent className="p-6">
              <h3 className="font-bold text-neutral-900 mb-4">Estadísticas</h3>
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-neutral-600">Tus Publicaciones</span>
                    <span className="text-lg font-bold text-neutral-900">23</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-neutral-600">Respuestas Dadas</span>
                    <span className="text-lg font-bold text-neutral-900">47</span>
                  </div>
                  <div className="h-1.5 bg-neutral-100 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-neutral-600">Puntos de Reputación</span>
                    <span className="text-lg font-bold text-neutral-900">156</span>
                  </div>
                  <div className="h-1.5 bg-neutral-100 rounded-full overflow-hidden">
          ...
          <Card className="border border-neutral-200">
            <CardContent className="p-6">
              <h3 className="font-bold text-neutral-900 mb-4">Usuarios Activos</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-xs text-neutral-500">{usuario.puntos} puntos</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <Card className="border border-blue-200 bg-blue-50">
            <CardContent className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Reglas de la Comunidad</h3>
