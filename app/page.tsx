        ...
        <>
                ...
                <div className="container relative z-10 mx-auto px-4 py-16 md:py-20 lg:py-24">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <AnimatedElement animation={{ translateY: [30, 0], opacity: [0, 1] }} delay={100}>
                            <h1 className="font-heading font-black mb-8 leading-[1.1] tracking-tight text-center">
                                <span className="aurora-text block mb-3 text-6xl md:text-8xl">
                                    Diseña el Futuro
                                </span>
                                <span className="aurora-text block text-5xl md:text-7xl">
                        ...
                        <AnimatedElement animation={{ translateY: [40, 0], opacity: [0, 1] }} delay={200}>
                            <p className="font-sans text-lg md:text-xl text-neutral-200 mb-12 max-w-3xl mx-auto font-normal leading-relaxed text-center">
                        ...
                        <AnimatedElement animation={{ translateY: [50, 0], opacity: [0, 1] }} delay={300}>
                            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                                <Link href="/cursos">
                                    <AnimatedButton size="lg" className="h-12 px-8 text-base font-medium bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-full backdrop-blur-sm transition-all duration-300">
                                        Explorar Cursos
                                        <ArrowRight className="ml-2 h-4 w-4" />
                                    </AnimatedButton>
                                </Link>
                                <Link href="/contacto">
                                    <AnimatedButton variant="outline" size="lg" className="h-12 px-8 text-base font-medium bg-white text-neutral-900 hover:bg-neutral-100 border-2 border-white rounded-full shadow-lg transition-all duration-300">
                                        Contactar
                                    </AnimatedButton>
                                </Link>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            ...
                            <ScrollReveal key={i} delay={i * 0.1} direction="up">
                                <div className="flex flex-col items-center text-center group bg-neutral-800/50 p-8 rounded-xl border border-neutral-700 hover:border-primary-600/50 transition-all">
                                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-600 to-primary-700 text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-xl">
            ...
            <section className="py-24 bg-neutral-900 text-white relative overflow-hidden">
                <div className="absolute inset-0 opacity-20">
                    <div className="absolute w-96 h-96 bg-primary-600/20 rounded-full blur-3xl top-1/2 left-1/4 -translate-y-1/2 animate-pulse"></div>
                    <div className="absolute w-96 h-96 bg-primary-500/15 rounded-full blur-3xl top-1/2 right-1/4 -translate-y-1/2 animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
